package com.haodong.practice.plugin
...
object Deps {
    ...
    const val livedata_ktx = "androidx.com.haodong.practice.ktx.core.lifecycle:com.haodong.practice.ktx.core.lifecycle-livedata-ktx:${Versions.livedata_ktx}"
    const val viewPager2 = "androidx.viewpager2:viewpager2:${Versions.viewPager2}"
    const val core_ktx = "androidx.core:core-ktx:${Versions.core_ktx}"
    const val navigation_fragment_ktx = "androidx.navigation:navigation-fragment-ktx:${Versions.navigation}"
    const val navigation_ui_ktx = "androidx.navigation:navigation-ui-ktx:${Versions.navigation}"
    const val recyclerView = "androidx.recyclerview:recyclerview:${Versions.recyclerView}"
    const val viewmodel_ktx = "androidx.com.haodong.practice.ktx.core.lifecycle:com.haodong.practice.ktx.core.lifecycle-viewmodel-ktx:${Versions.viewmodel_ktx}"
    const val lifecycle_extension = "androidx.com.haodong.practice.ktx.core.lifecycle:com.haodong.practice.ktx.core.lifecycle-extensions:${Versions.lifecycle_extension}"
